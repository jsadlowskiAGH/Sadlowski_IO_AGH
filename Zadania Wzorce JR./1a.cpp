...
public:
	...
	Computer assembleComputer2(ComputerBuilder& builder) {
		builder.buildCPU("Ryzen 7");
		builder.buildMemory("64GB");
		builder.buildStorage("476GB SSD");
		return builder.getResult();
	}
};
int main() {
	...
	Computer desktop2 = assembler2.assembleComputer2(desktopBuilder2);
	std::cout << "\nSecond Desktop Computer Configuration:" << std::endl;
	desktop2.display();
	return 0;
}